...
import DecoratedNewPlaylistForm from './components/new-playlist-form/NewPlaylistFormDecorator';
...
export default () => (
  <Router history={browserHistory}>
    <Route path="/" component={App} onEnter={onAppEnter}>
      ...
      <Route path="playlists" component={DecoratedNewPlaylistForm} onEnter={''} />
    </Route>
  </Router>
);
